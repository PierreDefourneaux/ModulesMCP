...
# 1. Définition du schéma de confirmation pour l'élicitation
...
async def roll_dice(ctx: Context) -> str:
    ...
    # 2. Déclenchement de l'élicitation
    # Cette méthode met l'outil en pause et envoie la question au client (ex: Claude Desktop)
    result = await ctx.elicit(
        message="Tu veux vraiment que je lance un dé ?",
        schema=ConfirmationRequest
    )

    # 3. Traitement de la réponse de l'utilisateur
